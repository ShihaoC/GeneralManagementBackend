...
public class UserService {
    ...
    public Response<User> login(User user) {
        ...
        return new ResponseFactory<User>().getInstance(resultUser, "success", ResponseCode.PASS);
    }
    ...
    public Response<String> register(User user) {
        ...
        if (insert > 0) {
            return new ResponseFactory<String>().getInstance("注册成功", "success", ResponseCode.PASS);
        }
